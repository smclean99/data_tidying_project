...
saveRDS(df1, file = "/cloud/project/data/raw_data/df_department.rds")
saveRDS(df2, file = "/cloud/project/data/raw_data/df_retail.rds")
```
...
df_total <- full_join(df_department, df_retail, by = c("business", "year", "n"))

```

```{r plot, warning=FALSE, fig.width=10} 
## Plot Retail Sales data
ggplot(df_retail, aes(x=year,y=n,colour=business)) + geom_point() 
